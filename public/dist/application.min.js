...
"use strict";angular.module("companies").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Companies",state:"companies",type:"dropdown",roles:["admin","user"]}),Menus.addSubMenuItem("topbar","companies",{title:"List Companies",state:"companies.list",roles:["admin","user"]}),Menus.addSubMenuItem("topbar","companies",{title:"Create Companies",state:"companies.create",roles:["admin"]})}]);
"use strict";angular.module("companies").config(["$stateProvider",function($stateProvider){$stateProvider.state("companies",{"abstract":!0,url:"/companies",template:"<ui-view/>"}).state("companies.list",{url:"",templateUrl:"modules/companies/client/views/list-companies.client.view.html",data:{roles:["admin","user"]}}).state("companies.create",{url:"/create",templateUrl:"modules/companies/client/views/create-company.client.view.html",data:{roles:["admin"]}}).state("companies.view",{url:"/:companyId",templateUrl:"modules/companies/client/views/view-company.client.view.html",data:{roles:["admin","user"]}}).state("companies.edit",{url:"/:companyId/edit",templateUrl:"modules/companies/client/views/edit-company.client.view.html",data:{roles:["admin"]}})}]);
...
"use strict";angular.module("core").controller("HomeController",["$scope","Authentication","ProductsNew","PurchasesExpired","PurchasesExpires",function($scope,Authentication,ProductsNew,PurchasesExpired,PurchasesExpires){$scope.authentication=Authentication,console.log($scope.authentication),$scope.findProducts=function(){$scope.authentication.user&&($scope.newProducts=ProductsNew.query())},$scope.expiredPurchases=function(){$scope.authentication.user&&($scope.expired=PurchasesExpired.query())},$scope.expiresPurchases=function(){$scope.authentication.user&&($scope.expires=PurchasesExpires.query())}}]);
...
"use strict";angular.module("purchases").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Purchases",state:"purchases",type:"dropdown",roles:["admin","user"]}),Menus.addSubMenuItem("topbar","purchases",{title:"List Purchases",state:"purchases.list",roles:["admin","user"]}),Menus.addSubMenuItem("topbar","purchases",{title:"Create Purchases",state:"purchases.create",roles:["admin"]})}]);
"use strict";angular.module("purchases").config(["$stateProvider",function($stateProvider){$stateProvider.state("purchases",{"abstract":!0,url:"/purchases",template:"<ui-view/>"}).state("purchases.list",{url:"",templateUrl:"modules/purchases/client/views/list-purchases.client.view.html",data:{roles:["admin","user"]}}).state("purchases.create",{url:"/create",templateUrl:"modules/purchases/client/views/create-purchase.client.view.html",data:{roles:["admin"]}}).state("purchases.view",{url:"/:purchaseId",templateUrl:"modules/purchases/client/views/view-purchase.client.view.html",data:{roles:["admin","user"]}}).state("purchases.edit",{url:"/:purchaseId/edit",templateUrl:"modules/purchases/client/views/edit-purchase.client.view.html",data:{roles:["admin"]}})}]);
...
"use strict";angular.module("reports").run(["Menus",function(Menus){Menus.addMenuItem("topbar",{title:"Reports",state:"reports",type:"dropdown",roles:["admin","user"]}),Menus.addSubMenuItem("topbar","reports",{title:"List Reports",state:"reports.list",roles:["admin","user"]})}]);
"use strict";angular.module("reports").config(["$stateProvider",function($stateProvider){$stateProvider.state("reports",{"abstract":!0,url:"/reports",template:"<ui-view/>"}).state("reports.list",{url:"",templateUrl:"modules/reports/client/views/list-reports.client.view.html",data:{roles:["admin","user"]}}).state("reports.view",{url:"/:reportId",templateUrl:"modules/reports/client/views/view-report.client.view.html",data:{roles:["admin","user"]}})}]);
